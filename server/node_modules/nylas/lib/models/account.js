...
function (_RestfulModel) {
  _inherits(Account, _RestfulModel);
...
Account.attributes = _objectSpread({}, _restfulModel["default"].attributes, {
  ...
  organizationUnit: _attributes["default"].String({
  ...
  linkedAt: _attributes["default"].DateTime({
    modelKey: 'linkedAt',
    jsonKey: 'linked_at'
  })
});